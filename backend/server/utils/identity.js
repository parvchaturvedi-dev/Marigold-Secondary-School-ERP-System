...
const normalizeStudentProfile = (student = {}, index = 0) => {
  ...
  return {
    ...
    tempAddress: student.tempAddress || raw.tempAddress || '',
    permAddress: student.permAddress || raw.permAddress || student.address || '',
    studentAadhar: student.studentAadhar || raw.studentAadhar || '',
    penNumber: student.penNumber || raw.penNumber || '',
    dateOfAdmission: student.dateOfAdmission || raw.dateOfAdmission || '',
    lastSchoolName: student.lastSchoolName || raw.lastSchoolName || '',
